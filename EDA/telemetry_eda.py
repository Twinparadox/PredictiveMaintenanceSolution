...
telemetry_path = os.path.join("data","telemetry","telemetry.csv") 
...
errors_path = os.path.join("data","telemetry","errors.csv") 
# errors.csv파일 읽어오기
...
print('-------------------------machine1 error with voltage-------------------------')
plt.plot(telemetry_machine1[telemetry_machine1['datetime'] < '2015-02-01']['datetime'],
         telemetry_machine1[telemetry_machine1['datetime'] < '2015-02-01']['volt'])
plt.xticks([])
plt.show()
...
machines_path = os.path.join("data","telemetry","machines.csv") 
# machines.csv파일 읽어오기
...
failures_path = os.path.join("data","telemetry","failures.csv") 
# machines.csv파일 읽어오기
