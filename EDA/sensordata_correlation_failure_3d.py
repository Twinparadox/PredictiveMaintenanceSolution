...
failure = machine1['failure']

print('-------------------------volt, rotate, pressure mean correlation-------------------------')
fig = plt.figure()
ax = fig.gca(projection = '3d')

ax.scatter(machine1['voltmean'], machine1['rotatemean'], machine1['pressuremean'], c=failure)
...
ax.scatter(machine1['voltmean'], machine1['rotatemean'], machine1['vibrationmean'], c=failure)
...
ax.scatter(machine1['voltmean'], machine1['pressuremean'], machine1['vibrationmean'], c=failure)
...
ax.scatter(machine1['rotatemean'], machine1['pressuremean'], machine1['vibrationmean'], c=failure)
...
ax.scatter(machine1['voltsd'], machine1['rotatesd'], machine1['pressuresd'], c=failure)
...
ax.scatter(machine1['voltsd'], machine1['rotatesd'], machine1['vibrationsd'], c=failure)
...
ax.scatter(machine1['voltsd'], machine1['pressuresd'], machine1['vibrationsd'], c=failure)
...
ax.scatter(machine1['rotatesd'], machine1['pressuresd'], machine1['vibrationsd'], c=failure)
